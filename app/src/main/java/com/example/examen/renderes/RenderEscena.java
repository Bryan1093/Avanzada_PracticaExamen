...
import com.example.examen.modelos.Prisma;
...
public class RenderEscena implements GLSurfaceView.Renderer {
    ...
    private float translacionAuto = 0;
    private float translacionDelta = 0.02f;
    private float translacionDeltaAuto = 1.0f;
    private static final float MAX_TRANSLATION = 5.0f;
    private static final float MIN_TRANSLATION = -5.0f;
    private static final float MAX_TRANSLATION_AUTO = 16.0f;
    private static final float MIN_TRANSLATION_AUTO = -9.0f;
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig config) {
        ...
        prisma = new Prisma(5,10,5,new float[]{1, 0, 0, 1, 1, 1, 0, 1});
        rio = new Rio();
        piso = new Rectangulo();
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        gl.glPushMatrix();
        {
            ...
            gl.glTranslatef(translacion, 0.0f, 0.0f);
        ...
        gl.glPushMatrix(); {
            ...
            if (translacionAuto >= MAX_TRANSLATION_AUTO || translacionAuto <= MIN_TRANSLATION_AUTO) {
                translacionDeltaAuto *= -1; // Cambiar la dirección
            }

        gl.glPushMatrix();
        {
            gl.glTranslatef(2.5f, 2.4f, -10.0f);
            gl.glTranslatef(translacionAuto, 0.0f, 0.0f);
        ...
        translacionAuto += translacionDeltaAuto;
