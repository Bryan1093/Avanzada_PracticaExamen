...
public class Prisma {
    ...
    private static float [] colorFigura;

    public Prisma(float width, float height, int numSides, float[] colorFigura) {
    ...
    public static void dibujar(GL10 gl) {
        ...
        gl.glColor4f(colorFigura[0], colorFigura[1], colorFigura[2], colorFigura[3]);
